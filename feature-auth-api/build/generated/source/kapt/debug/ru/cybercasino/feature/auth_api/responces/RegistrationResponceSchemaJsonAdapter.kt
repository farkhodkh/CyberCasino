...
public class RegistrationResponceSchemaJsonAdapter(
  moshi: Moshi
) : JsonAdapter<RegistrationResponceSchema>() {
  ...
  public override fun toString(): String = buildString(48) {
      append("GeneratedJsonAdapter(").append("RegistrationResponceSchema").append(')') }

  public override fun fromJson(reader: JsonReader): RegistrationResponceSchema {
    ...
    reader.endObject()
    return RegistrationResponceSchema(
        token = token ?: throw Util.missingProperty("token", "token", reader),
        user = user ?: throw Util.missingProperty("user", "user", reader)
    )
  }

  public override fun toJson(writer: JsonWriter, value_: RegistrationResponceSchema?): Unit {
    if (value_ == null) {
