...
public class RegistrationResponseSchemaJsonAdapter(
  moshi: Moshi
) : JsonAdapter<RegistrationResponseSchema>() {
  ...
  @Volatile
  private var constructorRef: Constructor<RegistrationResponseSchema>? = null

  public override fun toString(): String = buildString(48) {
      append("GeneratedJsonAdapter(").append("RegistrationResponseSchema").append(')') }

  public override fun fromJson(reader: JsonReader): RegistrationResponseSchema {
    ...
    if (mask0 == 0xffffffe0.toInt()) {
      ...
      val localConstructor: Constructor<RegistrationResponseSchema> = this.constructorRef ?:
          RegistrationResponseSchema::class.java.getDeclaredConstructor(Boolean::class.javaPrimitiveType,
  ...
  public override fun toJson(writer: JsonWriter, value_: RegistrationResponseSchema?): Unit {
    if (value_ == null) {
